...
void event_write_data(const char* disk_name, int block_size, const char* file_name, int inode_n, int offset,
                      int length);
void event_read_data(const char* disk_name, int block_size, const char* file_name, int inode_n, int offset, int length);
